...
public class CameraSettings {
    ...
    public static final boolean FIX_CONTINUOUS_SHOT_NUMBER = true;
    public static final String FIXED_CONTINUOUS_SHOT_NUMBER = "20";
    ...
    public static void initialCameraPictureSize(Context context, Parameters parameters) {
        ...
        if (supportedRatios != null && supportedRatios.size() > 0) {
            ...
            ratioString = supportedRatios.get(0); //modify by ChMX to set ration to 4/3 which is default value when restorePreferences
    ...
    private void initPreference(PreferenceGroup group) {
        ...
        synchronized (settingChecker) {
            ...
            if (SUPPORTED_SHOW_CONINUOUS_SHOT_NUMBER && !FIX_CONTINUOUS_SHOT_NUMBER) {
...
//            }
    ...
    public static void restorePreferences(Context context,
        ...
        if (backCameraId != -1) {
            ...
            if (Camera.mDisableFlash) {
            	editor.putString(CameraSettings.KEY_FLASH_MODE, "off");
            	editor.apply();
            }
        }
