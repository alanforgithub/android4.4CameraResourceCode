...
public class PickerButton extends RotateImageView implements View.OnClickListener {
    ...
    private boolean isFlashButton = false;  //add by ChMX for mantis 712
    ...
    public void onClick(View v) {
        ...
        if (Camera.mDisableFlash && isFlashButton) {
        	setValueState("off");
            return;
		}
    ...
    public void setValueState(String value) {
    	...
    	if (mListener != null && mListener.onPicked(this, mPreference, value)) {
            //clear override value after user changed it
            mPreference.setOverrideValue(null, false);
            mPreference.setValueIndex(index);//should be checked
            reloadPreference();
    ...
    //add by ChMX for mantis 712
    public void setFlashButton(boolean flashButton) {
    	isFlashButton = flashButton;
    }
