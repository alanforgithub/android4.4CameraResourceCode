...
public class ShutterManager extends ViewManager implements OnFullScreenChangedListener {
	...
	private static final int BACKKEY_BRIGHTNESS_MODE = 2;
    private static final int BACKKEY_BRIGHTNESS_ON = 255;
    private static final int BACKKEY_BRIGHTNESS_OFF = 0;
    private static final String ACTION_SET_BACKKEY_BRIGHTNESS = "com.ruimei.backkey.action.SET_BRIGHT";
    private static final String EXTRA_SET_BACKKEY_BRIGHTNESS_MODE = "mode";
    private static final String EXTRA_SET_BACKKEY_BRIGHTNESS_VALUE = "value";
	private Context mContext;
	private boolean offState = false;
	
    public void setBackKeyBrightness(boolean onOff) {
    	Intent intent = new Intent(ACTION_SET_BACKKEY_BRIGHTNESS);
      	intent.putExtra(EXTRA_SET_BACKKEY_BRIGHTNESS_MODE, BACKKEY_BRIGHTNESS_MODE);
        if (onOff) {
            intent.putExtra(EXTRA_SET_BACKKEY_BRIGHTNESS_VALUE, BACKKEY_BRIGHTNESS_ON);
        } else {
            intent.putExtra(EXTRA_SET_BACKKEY_BRIGHTNESS_VALUE, BACKKEY_BRIGHTNESS_OFF);
        }
